...
| Save | Saves pending changes. | Typically used after data is added or changed. |
...
See [Custom Actions](../../appGroups/admin/relational/relationalViews/actions.md#custom-actions)
