...
| OneStream Workflow Reference | nvarchar | How this unit maps to a OneStream workflow. | Only needed when the solution is driven by OneStream workflow. Currently the OneStream **parent** workflow profile name. Leave blank otherwise.
