...
Examples of future Excel integration use cases include:

- maintaining master data in Excel
- entering or updating planning data offline
- reviewing and editing larger sets of records in a spreadsheet format
- using dropdown-driven data entry for governed values
- submitting completed changes back into OneStream after offline work
